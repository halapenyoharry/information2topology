...
<!-- HY/draft-note 2026-05-28: a question I'm holding, not a verdict. This abstract promises two things — a rigorous *method* (format, firebreak, decision procedure, decomposition math) and a *cognitive* result (the recovery hypothesis, Section 8). The method I can defend on its own terms today. The cognitive claim I'm no longer sure belongs in *this* document at all — it may be a TopoThink-book claim that drifted into the math paper. Three live options, none collapsed yet: (a) cut the cognitive claim to the book and let this paper be purely the method, (b) keep it but explicitly demote it from "central radical claim" to "motivating conjecture, out of scope to prove here," (c) keep it and actually pay for it with cross-corpus evidence the paper doesn't yet contain. Not deciding here. Flagging that the abstract currently writes a check Section 8 can't cash. -->
## Abstract
...
<!-- HY/draft-note 2026-05-28: smaller, real, answer-in-text-before-someone-asks. "Four fundamental categories derived from first principles" — but the decision *tree* tests in a fixed order (time → enclosure → propagation → else), and that ordering is an unstated commitment doing silent classificatory work. Test enclosure before time and some edges land differently. So it's not purely four-from-first-principles; it's four primitives PLUS a priority ordering that isn't itself justified from first principles. Related: Reference is the else-branch — a residual, the junk drawer, structurally unlike the other three which each have a positive test. A careful reader notices that "derived from first principles" and "default case" are in tension. Neither is fatal. Both are cheap to disarm by just naming the ordering as a deliberate precedence rule (most-structural-commitment-first) rather than leaving it implicit. Holding whether Reference deserves a positive characterization or is honestly just "none of the above." -->
...
<!-- HY/draft-note 2026-05-28: this is the genre-leak point. This paragraph slides from a math result (decomposition recovers stable structure) straight into a mind claim (the structure reflects the author's attention patterns) inside a single sentence, with "reflect" doing all the load-bearing work and no argument under it. This is exactly the move I'd flag in someone else's draft: a smooth surface laid over a possibly-empty joint. The decomposition math earns "the structure is stably in the text." It does not earn "the structure was the shape of the writing mind." Keeping the sentence here, in the math section, makes the rigorous part look like it's smuggling the philosophy. Candidate fix I'm not committing to: move the attention-pattern sentence out of Section 7 entirely, leave Section 7 as pure decomposition, and let Section 8 own the conjecture honestly labeled as such. -->
...
<!-- HY/draft-note 2026-05-28: the core fork, held open. The claim is *cognitive isomorphism*: the topology = the shape of Camus's attention. The defense offered (Inter-Annotator Convergence) reaches a *different and weaker* target — it can show the structure is objectively in the *text*, recoverable by independent readers, like everyone independently finding the word "blue." It cannot reach back through the text to the *mind that produced it*, because the mind is sealed behind the linearization and all anyone ever has is the prose. So as written, the section claims X (cognition) and proves Y (textual objectivity), and the gap between X and Y is the whole soft underbelly a reviewer goes for first. Two honest moves and I genuinely don't know which yet: (1) WEAKEN — retitle to "Structural Objectivity," drop "attention/mind" language, claim only that the structure resides in the prose. Still strong, fully paid for, and arguably this is all the *math paper* should claim, with the cognition reserved for the book. (2) STRENGTHEN with evidence the paper lacks — cross-author recurrence (the superhypergraph-of-all-novels idea): a topology that recurs across hundreds of *independently authored* texts is evidence about narrative cognition in a way single-text annotator agreement never can be, because the convergence is now across writers, not across readers of one writer. That's the only validation that would actually reach "mind," and it's not in this document. Not resolving. The thing I'm sure of: "boldest, most radical claim" + a defense that proves something else = the most fragile paragraph in the paper. -->
...
<!-- HY/draft-note 2026-05-28: watch this exact sentence — it performs the slide in miniature. First clause: "resides objectively in the prose" (TRUE, this is what convergence buys). Then "proving that the text is a stable linearization of the author's attention patterns" (NOT proven — "linearization of attention" presupposes the attention-structure existed pre-text and the prose is its flattening, which is the conclusion, not something convergence establishes). The word "proving" is too strong for what precedes it even on the generous reading. If I keep the cognitive frame at all, this is "consistent with," never "proving." If I take the weaken-path, this sentence stops at "resides objectively in the prose itself" full stop and the rest goes to the book. -->
...
<!-- HY/draft-note 2026-05-28: the superhypergraph belongs HERE, as an open question, not yet as a claim. The cross-corpus / superhypergraph-of-all-novels idea isn't just "more recurrence for the type-quotient demo" — it's structurally the *only* evidence-engine that could move Section 8's recovery hypothesis from "in the text" toward "about narrative cognition." Cross-author structural recurrence is a different epistemic object than within-text annotator convergence. Worth a dedicated open question: "Does a structure recurring across N independently authored corpora license a cognitive claim that single-corpus convergence cannot?" That question, answered, is what decides whether Section 8 weakens to textual-objectivity or earns its cognitive frame. Possibly this is where info2topology stops being a single-artifact method and becomes a map of where structure lives across artifacts — but that may be the book's territory, not this paper's. Holding the scope line, not drawing it yet. -->
